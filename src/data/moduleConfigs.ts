...
const studentFormFields: FormField[] = [
  ...
  { key: "curriculumSubjects", label: "المناهج", type: "multiselect", required: true },
...
const allModuleConfigs: ModuleConfig[] = [
  {
    ...
    formFields: [
      ...
      { key: "gradeId", label: "الصف", type: "select", options: gradeOptions, required: true },
      { key: "track", label: "المسار", type: "select", options: trackOptions },
      { key: "teachingSubjects", label: "المناهج التي يدرسها", type: "multiselect", required: true },
      {
  ...
  },
  {
    ...
    description: "إنشاء مجموعات طلبة وربطها بأكثر من معلم وأكثر من طالب.",
    collection: "studentGroups",
    roles: ["admin"],
    scope: { type: "all" },
    tableFields: ["name", "gradeId", "track", "curriculumSubjects", "teacherIds", "studentIds", "status"],
    searchableFields: ["name", "gradeId", "track", "curriculumSubjects"],
    formFields: [
      { key: "name", label: "اسم المجموعة", type: "text", required: true },
      { key: "gradeId", label: "الصف", type: "select", options: gradeOptions, required: true },
      { key: "track", label: "المسار", type: "select", options: trackOptions },
      { key: "curriculumSubjects", label: "المناهج", type: "multiselect", required: true },
      { key: "teacherIds", label: "المعلمون", type: "multiselect", reference: { collection: "teachers", labelKey: "fullName" }, required: true },
      { key: "studentIds", label: "الطلاب", type: "multiselect", reference: { collection: "students", labelKey: "fullName" } },
      { key: "description", label: "وصف المجموعة", type: "textarea" },
      { key: "status", label: "الحالة", type: "select", options: statusOptions, required: true },
    ],
  },
  {
  ...
  },
  {
    ...
    ownerField: "teacherId",
    mode: "import",
    tableFields: ["fullName", "username", "nationalId", "gradeId", "track", "curriculumSubject", "whatsappNumber", "email"],
  ...
  },
  {
    ...
    scope: { type: "studentArray", field: "teacherIds" },
    mode: "export",
    tableFields: ["fullName", "username", "nationalId", "gradeId", "track", "curriculumSubject", "whatsappNumber", "email", "status"],
    searchableFields: ["fullName", "username", "nationalId", "email"],
    formFields: studentFormFields,
  },
  {
