...
export const teacherModules: SpecModule[] = [
  {
    ...
    fields: ["الاسم الكامل", "رقم الهوية", "المرحلة", "الصف", "رقم الواتس", "البريد الإلكتروني", "الحالة"],
  ...
  },
  {
    ...
    eyebrow: "Teacher",
    collection: "students",
    description: "استيراد ملف Excel مع التحقق من الاسم ورقم الهوية والهاتف ومطابقة الصف للمرحلة.",
    fields: ["الاسم الكامل", "رقم الهوية", "المرحلة التعليمية", "الصف", "رقم الواتس", "البريد الإلكتروني"],
  ...
  },
  {
    ...
    fields: ["العنوان", "المادة", "الصف", "المرحلة", "الأهداف", "نمط التعلم", "درجة النجاح", "الحالة"],
