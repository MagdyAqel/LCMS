...
export const palestinianTeacherSpecializations = [
  "اللغة العربية",
  "اللغة العربية أساليب",
  "اللغة الإنجليزية",
  "اللغة الإنجليزية أساليب",
  "اللغة الفرنسية",
  "التربية الإسلامية",
  "التربية الإسلامية أساليب",
  ...
  "التاريخ",
  "الجغرافيا",
  "المرحلة الأساسية الأولى / أدبي",
  "المرحلة الأساسية / أدبي",
  "المرحلة الأساسية الأولى / علمي",
  "المرحلة الأساسية / علمي",
  "رياض الأطفال",
  "التربية الرياضية",
  "التربية الفنية",
  "التربية الموسيقية",
